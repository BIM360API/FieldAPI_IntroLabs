...
namespace FieldAPIIntro
{
    class Field
    {
        ...
        /// On success, returns a 36 byte GUID "ticket" which needs to be 
        /// passed in on subsequent calls.
        /// Doc
        ...
        public static List<Issue> IssueList(string ticket, string project_id, string area_ids="", int offset=0, int limit=20)
        {
            ...
            //request.AddParameter("area_ids", area_ids); No used for this. 
            //request.AddParameter("offset", offset); // MH: Does not do anything.

            // limit - default seems to be 25. 
            // uncomment this if you want to have a whole list 
            request.AddParameter("limit", limit); // MH: If you specify other than "", it returns the whole list.   
        ...
        public static string IssueCreate(string ticket, string project_id, string issues)
        {
            ...
            return issueCreateResponse[0].id; // return the id of the first issue created for this exercise. 
        }
